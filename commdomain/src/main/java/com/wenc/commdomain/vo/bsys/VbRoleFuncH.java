...
@Entity
@Table(name = "vb_role_func_h")
public class VbRoleFuncH {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbRoleFuncH that = (VbRoleFuncH) o;
        return idx == that.idx &&
                ...
                Objects.equals(funcOrder, that.funcOrder);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, roleId, funcNo, actr, addr, modr, delr, prtr, othr, chkr, quyr, state, createUser, createTime, lastmodify, descr, funcOrder);
    }
