...
@Entity
@Table(name = "vb_retailsale_h")
public class VbRetailsaleH {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbRetailsaleH that = (VbRetailsaleH) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, saleNo, shopId, posNo, startDate, endDate, shroffId, salesmanId,
                claimmanId, discountmanId, changemanId, giftmanId, debitmanId, reserverId, operatorId, amount,
                realAmt, discountAmt, doctorId, patientId, departId, ybcardNo, medrecNo, prescriptionNo, billType, billNo, saleType, oriorderNo, synState, idcardNo, customName, customTelno, vipCode, orgName, orgAtrrib);
    }
}
