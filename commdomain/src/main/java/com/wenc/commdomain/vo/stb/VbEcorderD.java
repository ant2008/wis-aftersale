...
@Entity
@Table(name = "vb_ecorder_d")
public class VbEcorderD {
    private long idx;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, ecorderNo, itemId, barCode, ecCode, orderQty, realQty, orderPrice, purPrice, salePrice, memPrice, realPrice, orderAmt, realAmt, supllierId, supplierName, imgUrl, skuId, itemName, itemType, detailPageUrl, customsCode, presaleType, distribPrice, itemSpec, oriItemNo, discountPrice, distribAmt, itemUnit, itemSubno, prdOrigin, prdFactory, state);
    }
}
