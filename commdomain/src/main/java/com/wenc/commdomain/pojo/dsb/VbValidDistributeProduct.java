...
@Entity
@Table(name = "vb_valid_distribute_product")
public class VbValidDistributeProduct {
    private long idx;
    ...
    @Basic
    @Column(name = "item_pic1", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "item_pic2", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "item_pic3", nullable = true, length = 500)
    ...
    public boolean equals(Object o) {
        ...
        VbValidDistributeProduct that = (VbValidDistributeProduct) o;
        return idx == that.idx &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, itemId, itemDescribe, extraId, authzTenantId, vendorId, vendorName,
                ...
                proposalPriceS, proposalPriceH, allowBelowDsbprice, applyDate, applyTenantId, applyUserId,
                applyUserName, chkUserId, chkUserName, chkResult, chkState, chkDate, itemType, itemState, createUser, createTime, distributionPic, itemName, itemUnit, itemSubno, itemSpec, prdOrigin, prdFactory, extraIdx, vendorTenantId, vendorIdx, itemPic1, itemPic2, itemPic3, prdAttrib);
    }
}
