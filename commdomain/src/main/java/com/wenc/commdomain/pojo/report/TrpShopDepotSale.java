...
@Entity
@Table(name = "trp_shop_depot_sale")
public class TrpShopDepotSale {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        TrpShopDepotSale that = (TrpShopDepotSale) o;
        return idx == that.idx &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, statDate, shopId, depotId, saleQty, purAmt, dueAmt, realAmt, shoppeAmt, customerFlow, createUser, createTime);
    }
}
