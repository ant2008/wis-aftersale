...
@Entity
@Table(name = "vb_reservation_account")
public class VbReservationAccount {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbReservationAccount that = (VbReservationAccount) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, reservationType, reservationDate, reservationNo, reservationUserName,
                ...
                , distributionName, salesmanId, salesmanName, salesmanMobileNo, doState, writeoffCode, writeoffDate,
                writeoffUserId, confirmCode, itemId, itemName, state, createUser, createTime, scheduleIdx, scheduleType, scheduleRangeType, distributionItemId, scheduleSiteId, scheduleSiteName, scheduleSiteAddress, scheduleDate, scheduleNum, usedNum);
    }
}
