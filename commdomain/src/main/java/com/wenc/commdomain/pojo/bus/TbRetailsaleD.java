...
@Entity
@Table(name = "tb_retailsale_d")
public class TbRetailsaleD {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        TbRetailsaleD that = (TbRetailsaleD) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, saleNo, rowNo, goodsSnf, barCode, itemId, shipNo, depotId, salePrice,
                itemQty, saleTomin, minPrice, minQty, realPrice, itemRate, rateType, rateCause, promNo, fileNo, saleAmt, realAmt, notes, clerkerId, clerkAmt, costType, outDepotid, ifLimit, limitQty, ifProm, promDescr, matchQty, matchAmt, itemType, promType, rateQty, rateAmt, presQty, parentItemid);
    }
}
