...
@Entity
@Table(name = "vb_distrib_writeoff_account")
public class VbDistribWriteoffAccount {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbDistribWriteoffAccount that = (VbDistribWriteoffAccount) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, writeoffType, writeoffDate, distributorId, salesmanId, customerId,
                ...
                customerMinappId, writeoffUserId, state, doState, createUser, createTime, distributeTenantId, vendorTenantId, cofirmCode, distributeName, salesmanName, itemName, vendorId, vendorName, salesmanType, salesmanIdnum, salesmanLevel, salesmanIntegral, userId);
    }
