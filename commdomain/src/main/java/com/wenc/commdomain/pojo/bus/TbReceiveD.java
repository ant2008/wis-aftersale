...
@Entity
@Table(name = "tb_receive_d")
public class TbReceiveD {
    private long idx;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, receiveNo, enterNo, itemId, barCode, shipNo, shelf, orderPrice, purPrice, purTax, purQty, salePrice, saleTax, overdueDate, rebate, tariff, rate, othRate1, othRate2, notes, flag, itempackNum, cmpackNum, makeTime);
    }
