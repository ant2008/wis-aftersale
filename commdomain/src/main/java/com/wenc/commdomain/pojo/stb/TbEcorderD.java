...
@Entity
@Table(name = "tb_ecorder_d")
public class TbEcorderD {
    private long idx;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, ecorderNo, itemId, barCode, ecCode, orderQty, realQty, orderPrice, purPrice, salePrice, memPrice, realPrice, orderAmt, realAmt, supllierId, supplierName, imgUrl, skuId, itemName, itemType, detailPageUrl, customsCode, presaleType, distribPrice, itemSpec, oriItemNo, discountPrice, distribAmt);
    }

    @Basic
    @Column(name = "ori_item_name", nullable = true, length = 300)
