...
@Entity
@Table(name = "vb_pltecorder_h")
public class VbPltecorderH {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbPltecorderH that = (VbPltecorderH) o;
        return idx == that.idx &&
                Objects.equals(tenantId, that.tenantId) &&
                Objects.equals(ecorderNo, that.ecorderNo) &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, ecorderNo, orderType, createType, depotId, depotName, estoreId, estoreName
                , customerId, customerName, customerMobile, customerEmail, customerMemo, customerIdcard, addrCountry,
