...
@Entity
@Table(name = "tb_supply_order_h")
public class TbSupplyOrderH {
    private long idx;
    ...
    @Basic
    @Column(name = "supply_order_no", nullable = true, length = 30)
    ...
    public boolean equals(Object o) {
        ...
        TbSupplyOrderH that = (TbSupplyOrderH) o;
        return idx == that.idx &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, supplyOrderNo, distributeOrderNo, orderType, createType, distributorId,
                distributorName, vendorId, vendorName, depotId, depotName, estoreId, estoreName, customerId,
                customerName, customerMobileNo, customerEmail, customerMemo, customerIdcard, addrCountry,
                addrProvince, addrCity, addrRegion, addrStreet, addrDetail, postCode, ifInvoice, invoiceType,
                invoiceTitle, sellerMemo, sellerMobileno, orderMark, orderAmt, postFee, totalAmt, totalDiscountAmt,
                ifSelfmention, selfmemtionMemo, payAmt, payType, payTypeStr, payTime, payTransactionNo,
                orderCloseType, expiredTime, consignTime, refundState, oriOrderNo, oriOrderType, oriOrderTypeDescr,
                oriStatus, oriStatusDescr, oriCreateTime, oriPayTime, successTime, orderFrom, transState, ecorderTopno, doState, state, execDate, payState, saleNo, chkBit, createTime, createUser, expressType, ifMemberOrder, ifDistribOrder, ifRetailOrder, ifRefundOrder, ifVirtualOrder, ifFeedback, expressId, expressName, expressNo, senderName, senderMobileno, authzTenantId, addrDomain, addrFulldetail, senderAddr, estoreType, salesmanId, salesmanMobileNo, salesmanName, confirmCode, distributeTenantId);
    }
}
