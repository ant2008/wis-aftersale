...
@Entity
@Table(name = "tb_retailsale_sum_h")
public class TbRetailsaleSumH {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        TbRetailsaleSumH that = (TbRetailsaleSumH) o;
        return idx == that.idx &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, retailsaleSumNo, shopId, posNo, salesmanId, salesmanName, beginNo, endNo, beginTime, endTime, realsumAmt, salesumAmt);
    }
}
