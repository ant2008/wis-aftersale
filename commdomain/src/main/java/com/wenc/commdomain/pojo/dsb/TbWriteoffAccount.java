...
@Entity
@Table(name = "tb_writeoff_account")
public class TbWriteoffAccount {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        TbWriteoffAccount that = (TbWriteoffAccount) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, writeoffType, writeoffDate, distributorId, salesmanId, customerId,
                writeoffCode, itemId, itemPrice, realPrice, commissionRate, orderAmt, realAmt, distributeOrderNo, supplyOrderNo, salesmanMobile, customerMobile, writeoffUserId, state, createUser, createTime, distributeTenantId);
    }
