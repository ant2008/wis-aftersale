...
@Entity
@Table(name = "vb_gl_distribprd_apply")
public class VbGlDistribprdApply {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        VbGlDistribprdApply that = (VbGlDistribprdApply) o;
        return idx == that.idx &&
    ...
    public int hashCode() {
        return Objects.hash(idx, tenantId, itemId, itemDisctribe, extraId, authzTenantId, vendorId, vendorName,
                ...
                proposalPriceS, proposalPriceH, allowBelowDsbprice, applyDate, applyTenantId, applyUserId, applyUserName, chkUserId, chkUserName, chkResult, chkState, chkDate, itemType, itemState, createUser, createTime, distributionPic, itemName, itemUnit, itemSubno, itemSpec, prdOrigin, prdFactory, extraIdx, vendorTenantId, vendorIdx);
    }
