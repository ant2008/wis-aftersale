...
@Entity
@Table(name = "tb_supply_performance_d")
public class TbSupplyPerformanceD {
    private long idx;
    private String tenantId;
    private String performanceNo;
    private String supplyOrderNo;
    private BigDecimal supplyOrderAmt;
    private Timestamp supplyOrderDate;
    ...
    @Basic
    @Column(name = "supply_order_date", nullable = true)
    public Timestamp getSupplyOrderDate() {
        return supplyOrderDate;
    }

    public void setSupplyOrderDate(Timestamp supplyOrderDate) {
    ...
    public boolean equals(Object o) {
        ...
        TbSupplyPerformanceD that = (TbSupplyPerformanceD) o;
        return idx == that.idx &&
                ...
                Objects.equals(supplyOrderDate, that.supplyOrderDate) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, performanceNo, supplyOrderNo, supplyOrderAmt, supplyOrderDate,
                distributeOrderNo, distributeOrderDate, distributeOrderAmt, commissionPrice, commissionAmt, commissionRate, confirmCommissionAmt, commissionPaymentAmt, commissionState, platformRate, platformAmt);
    }
}
