...
@Entity
@Table(name = "tb_supply_order_d")
public class TbSupplyOrderD {
    private long idx;
    ...
    public boolean equals(Object o) {
        ...
        TbSupplyOrderD that = (TbSupplyOrderD) o;
        return idx == that.idx &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idx, tenantId, supplyOrderNo, itemId, barCode, ecCode, orderQty, realQty, orderPrice,
