...
import static com.wiser.hw.dms.restful.ApiUtils.acknowledgeMessages;
import static com.wiser.hw.dms.restful.ApiUtils.constructTempMessages;
import static com.wiser.hw.dms.restful.ApiUtils.consumeMessages;
import static com.wiser.hw.dms.restful.ApiUtils.createGroup;
import static com.wiser.hw.dms.restful.ApiUtils.createQueue;
import static com.wiser.hw.dms.restful.ApiUtils.deleteGroup;
import static com.wiser.hw.dms.restful.ApiUtils.deleteQueue;
import static com.wiser.hw.dms.restful.ApiUtils.getGroups;
import static com.wiser.hw.dms.restful.ApiUtils.getQuota;
import static com.wiser.hw.dms.restful.ApiUtils.listQueues;
import static com.wiser.hw.dms.restful.ApiUtils.parseHandlerIds;
import static com.wiser.hw.dms.restful.ApiUtils.parseQueueGroupId;
import static com.wiser.hw.dms.restful.ApiUtils.parseQueueId;
import static com.wiser.hw.dms.restful.ApiUtils.retrieveQueue;
...
import com.wiser.hw.dms.restful.access.AccessServiceUtils;
