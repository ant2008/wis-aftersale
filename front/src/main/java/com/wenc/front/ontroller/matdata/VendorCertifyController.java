...
import com.wenc.commdomain.vo.sys.AccountApplicationVO;
...
@Api("供应商资质申请")
@RequestMapping("MVenCertify")
@RestController
public class VendorCertifyController extends AbstractBaseSingleController<TbAccountCertify,TbAccountCertify> {

    private Logger LOG = LoggerFactory.getLogger(VendorCertifyController.class);
    ...
    public VendorCertifyController() {
        super();
    }
     ...
     * todo:待测试
     */
    @ApiOperation(value = "ApplyCertify",notes = "供应商资质提交")
    @ApiImplicitParams({
                                                             ...
                                                             @RequestParam String aLegralIdCardPicBack)
    {
        ...
        try
        {
            ...
            accountCertifyVO = accountCertifyService.addAccountCertify(
                    getLoginTenantId(),
                    getLoginUserId(),
                    "0",
                    aCompanyName,
     ...
     * @return
     */
    @ApiOperation(value = "GetVendorCertify",notes = "获取供应商认证")
    @RequestMapping(value = "GetVendorCertify", method = RequestMethod.GET)
    public BaseRetModel<AccountCertifyVO> getVendorCertify(HttpSession session,
                                                             HttpServletRequest request,
                                                             HttpServletResponse response)
    {
        BaseRetModel<AccountCertifyVO> retModel = new BaseRetModel<>();
        ...
        try
        {
            ...
            tbAccountCertify = accountCertifyService.getAccountCertify(getLoginTenantId(),"0");
                                                        ...
                                                        )
    {
        ...
        String path =  "/tmp_upload/certify/";
        ...
        try
        {
           ...
           // filePath = session.getServletContext().getRealPath(path);
            ...
            //组成新的路径
            saveFilePath = filePath+uploadFileConfig.getVendorCertify();
