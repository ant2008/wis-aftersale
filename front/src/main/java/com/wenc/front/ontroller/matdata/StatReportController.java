...
import com.wenc.commdomain.pojo.matdata.TsStatReportLog;
 ...
 * 报表统计
 */
@RequestMapping("MStatReportLog")
@RestController
public class StatReportController extends AbstractBaseSingleController<TsStatReportLog,TsStatReportLog> {
     ...
     * @return
     */
    @RequestMapping(value = "StatDailyReport",method = RequestMethod.POST)
                                              ...
                                              @RequestParam String aStatDate)
    {
        ...
        try
        {
            ...
            reportService.statDailyReport(statDate,getLoginTenantId(),getLoginUserId());
